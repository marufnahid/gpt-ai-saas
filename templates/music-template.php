                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="input-group mb-3">
                                <textarea type="text" id="textareaPrompt" class="form-control" placeholder="Enter your questions..." aria-label="Enter your questions here..." aria-describedby="button-addon2"></textarea>
