                        ...
                        <div class="col-md-12 ">
                            <div class="mb-3">
                                ...
                                <label for="lanugageSoftware"
                                       class="form-label"><?php esc_html_e('Language', 'gpt-ai-saas'); ?></label>
                                <select name="lanugageSoftware" id="lanugageSoftware">
                                    <option value="<?php esc_attr_e('English', 'gpt-ai-saas'); ?>" selected><?php esc_html_e('English', 'gpt-ai-saas'); ?></option>
                                    <option value="<?php esc_attr_e('French', 'gpt-ai-saas'); ?>"><?php esc_html_e('French', 'gpt-ai-saas'); ?></option>
                                    <option value="<?php esc_attr_e('Spanish', 'gpt-ai-saas'); ?>"><?php esc_html_e('Spanish', 'gpt-ai-saas'); ?></option>
                                    <option value="<?php esc_attr_e('Italian', 'gpt-ai-saas'); ?>"><?php esc_html_e('Italian', 'gpt-ai-saas'); ?></option>
                                    <option value="<?php esc_attr_e('German', 'gpt-ai-saas'); ?>"><?php esc_html_e('German', 'gpt-ai-saas'); ?></option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="keywords"
                                       class="form-label"><?php esc_html_e('Keywords', 'gpt-ai-saas'); ?></label>
                                <input type="text" class="form-control" id="keywords" placeholder="<?php esc_html_e('Write keywords for hashtags..', 'gpt-ai-saas'); ?>"/>
                            </div>
                            <label for="textareaPrompt"
                                   class="form-label"><?php esc_html_e('Description of your Hashtags', 'gpt-ai-saas'); ?></label>
                            <div class="mb-3 input-group">
                                <textarea type="text" id="textareaPrompt" class="form-control"
                                          placeholder="<?php esc_html_e('I am on the beach with a dog...', 'gpt-ai-saas'); ?>"
                                          aria-label="<?php esc_html_e('I am on the beach with a dog...', 'gpt-ai-saas'); ?>"
                                          aria-describedby="button-addon2"></textarea>
                                <button class="btn btn-outline-primary mb-0" type="button"
                                        id="hashtagSubmit"><?php esc_html_e('Submit', 'gpt-ai-saas'); ?>
                                </button>
                            </div>
                        </div>
