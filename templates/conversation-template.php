                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                ...
                                <label for="textareaPrompt"
                                       class="form-label"><?php esc_html_e('Description of your question...', 'gpt-ai-saas'); ?></label>
                                <div class="input-group mb-3">
                                <textarea type="text" id="textareaPrompt" class="form-control"
                                          placeholder="<?php esc_html_e('Enter your questions...', 'gpt-ai-saas'); ?>"
                                          aria-label="<?php esc_html_e('Enter your questions here...', 'gpt-ai-saas'); ?>"
                                    ...
                                    <button class="btn btn-outline-primary mb-0" type="button" id="conversationSubmit">
                                        <?php esc_html_e('Submit', 'gpt-ai-saas');?>
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="input-group mb-3">
                                <textarea type="text" class="form-control" id="chatOutput" placeholder="<?php esc_html_e('I am GPT, I will give any kind of questions answer.', 'gpt-ai-saas'); ?>"
